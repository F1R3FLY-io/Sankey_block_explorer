...
const Button: React.FC<ButtonProps> = ({
  ...
  const variantStyles = {
    primary: isGradient 
      ? 'gradient-primary text-white focus:ring-primary-500' 
      : 'bg-primary-600 hover:bg-primary-700 text-white focus:ring-primary-500',
    secondary: isGradient 
      ? 'gradient-secondary text-white focus:ring-secondary-500' 
      : 'bg-secondary-600 hover:bg-secondary-700 text-white focus:ring-secondary-500',
    outline: 'border border-gray-300 bg-transparent hover:bg-gray-50 dark:hover:bg-gray-800 text-gray-700 dark:text-gray-200 focus:ring-gray-500',
